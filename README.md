...
* AddPremis: Adds a serialized version of the PREMIS Turtle RDF for the node generated by the [Islandora PREMIS](https://github.com/mjordan/islandora_premis) module, if it is enabled in the host Drupal.
